...
status: active
summary: validation導入は実装できたため，TrackEval統合の切り分けと計算時間分析を進めつつ，SAM2/SAMURAI改善としてstate carry型Mambaを評価している。
created: 2026-07-07
...
- [ ] TrackEval 側の関数化導線を単体で検証し、統合時の問題を切り分ける
- [ ] tracking validation の命名整理と運用方針の明確化
